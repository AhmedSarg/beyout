      ...
      children: [
        ...
        Row(
          children: [
            ...
            InkWell(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(right: 12.0),
                  child: Text('Create Account',style: AppTextStyles.authSocialTextStyle(context),),
                )),
          ],
        ),
        const SizedBox(height: 10,),
        ...
        const Center(
          child:  Column(
            ...
            children: [
              SocialContainer(title: 'Sign up with google',),
              SizedBox(height: 10,),
              SocialContainer(title: 'Sign up with facebook',),
            ],
          ),
        )
