...
class _GoogleMapScreenState extends State<GoogleMapScreen> {
  ...
  List<PlaceModel> places = [
    PlaceModel(
        1,
        'Home 1',
        LatLng(30.47286017012721, 31.18171947364892),
        '01012951616',
        'benha',
        'شارع هاني علي كامل بجوار مستشفي الجامعه Fareed Nada Street, Banha, Al-Qalyubia Governorate 13511'),
    PlaceModel(2, 'Home 2', LatLng(30.084660155142792, 31.22542341623401),
        '0113492560', 'cairo', 'Corniche، النيل, Giza Governorate'),
    PlaceModel(3, 'Home 3', LatLng(31.212075763969697, 29.998351446306977),
        '0125828592', 'alex', 'Khorshid Al Qebleyah'),
    PlaceModel(
        4,
        'Home 4',
        LatLng(24.085829684067846, 32.89478440574677),
        '0114091230',
        'aswan',
    ...
    PlaceModel(
        5,
        'Home 5',
        LatLng(28.077208703415202, 30.71455257860048),
        '01012951616',
        'sohag',
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '${tappedMarker!.infoWindow.snippet}',
                              style:
                                  AppTextStyles.googleMapHomeTitleTextStyle(),
                            ),
                            Text(
                              'House',
                              style: AppTextStyles
                            ...
                            Text(
                              'Details',
                              style: AppTextStyles
                                  .googleMapHomeDetailsTitleTextStyle(),
                            ),
                            Container(
                              width: double.infinity,
                              child: Card(
